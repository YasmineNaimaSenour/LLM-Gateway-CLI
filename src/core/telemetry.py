...
class Timer:
    ...
    # Property (not a plain attribute) so elapsed time is computed lazily,
    # only when read, and stays read-only.
    @property
...
# Thin convenience wrapper around Timer: same clock, context-manager form.
@contextmanager
